    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        submit1.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View view)
            {
                ...
                String cityStr = cityname1.getText().toString().trim();


                if (TextUtils.isEmpty(cityStr)) {

                    cityname1.setError("Enter Name");
                }
                if (cityStr.length() == 0) {
                    cityname1.setError(("Field cannot be Empty"));
                } else
                {
                    Toast.makeText(MainActivity.this, "" + cityStr, Toast.LENGTH_LONG).show();
                }
